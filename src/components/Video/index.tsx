            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16 medium:flex-col">
                    ...
                    <div className="flex flex-col gap-4 medium:w-full">
                        ...
                        <a
                            href=""
                            className="p-4 text-small border border-blue-500 text-blue-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-blue-500 transition-colors hover:text-gray-900"
                        >
                            <Lightning size={24} />
                            Acesse o desafio
                        </a>
